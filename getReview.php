...
// $checkUsername = pg_query($con,"SELECT * FROM daftar");
...
<form class="row g-3" action="" method="post">
  <div class="col-md-2">
    ...
    <input type="text" name="fname" required class="form-control" id="validationDefault01" placeholder="First Name" required>
  </div>
  <div class="col-md-2">
    <label for="validationDefault02" class="form-label">Last name</label>
    <input type="text" name="lname" required class="form-control" id="validationDefault02" placeholder="Last Name" required>
  </div>
  <div class="col-md-2">
  ...
  <div class="col-md-2">
    ...
    <div class="input-group">
      ...
      <input type="number" required class="form-control" id="validationDefaultUsername" name="score"  aria-describedby="inputGroupPrepend2" required>
    </div>
  </div>

  <div class="mb-1">
  <label for="exampleFormControlTextarea1" class="form-label">Opinions</label>
  <textarea class="form-control" name="opinion" required id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
  <div class="col-6">
